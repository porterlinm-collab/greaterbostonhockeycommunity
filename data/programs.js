// To add a program: copy an object below, fill in the fields, add it to the right category array.
// "link" and "link2" are optional. "contact" is optional plain text (e.g. "Contact info: TBD").
...
const programData = {
  "Beginner / Learn-to-Play Programs": [
    {
      ...
      location: "Simoni Rink, Cambridge",
  ...
  "Women's Clinics & Stick and Pucks": [
    ...
    {
      name: "Warrior – Women's Skills",
      schedule: "Runs Mondays, 8:00 – 8:50 PM.",
      location: "Warrior Arena, Brighton",
  ...
  "Women's Leagues": [
    ...
    {
      name: "South Shore Women's League",
      details: "Levels: A-D. Free agents/Subs welcome to sign up.",
      schedule: "Runs Sundays, Sep – Mar.",
      location: "Various rinks",
  ...
  "Women's Tournaments": [
    ...
    {
      name: "Clover Cup",
      details: "Levels: D, C, A/B.",
      schedule: "March each year.",
      location: "The Bog Ice Arena, Kingston",
      link: "https://baystatehockeyleague.com/club/clovercup",
    },
  ],

  "Women's Hockey Camps": [
    {
